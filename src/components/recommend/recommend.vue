...
<!--                        ref="inpu">-->
         ...
         <div class="dao">
             <ul>
                 <li><a href="###"><span class="s1"></span><p>攻略</p></a></li>
                 <li><a href="###"><span class="s2"></span><p>度假</p></a></li>
                 <li><a href="###"><span class="s3"></span><p>玩乐</p></a></li>
                 <li><a href="###"><span class="s4"></span><p>美物</p></a></li>
                 <li><a href="###"><span class="s5"></span><p>研究</p></a></li>
             </ul>
         </div>
        ...
        <div class="two" v-for="item in product" >

                    <toua>
                      <h2>{{item.categoryTitle}}</h2>
                 <a :href="item.moreUrl" class="right">更多</a>
                    </toua>
                    <div class="ac">
                     <ul>
                           <li v-for="it in item.list"><a :href="it.webUrl" class="ac-a"><img :src="it.productCover" alt=""><p class="a">{{it.productName}}</p><p class="b">{{it.productArea+(it.productCity?'-':'')+it.productCity}}</p><p class="c">{{'￥'+it.productPrice+'起'}}</p></a></li>
                     </ul>
...
<script>
    ...
    import {urla,urlb,urlc,urld,urle,urlh} from "@/api/getDissList";
            ...
            ul
                ...
                li
                    ...
                    a
                        ...
                        span
                            display block
                            background: url("./p1.png") no-repeat center
                        ...
                        .s1
                            background: url("./p1.png") no-repeat center
                        .s2
                            background: url("./p2.png") no-repeat center
                        .s3
                            background: url("./p3.png") no-repeat center

                        .s4
                            background: url("./p4.png") no-repeat center
                        .s5
                            background: url("./p5.png") no-repeat center
                        p
                             display block
                             text-align center
